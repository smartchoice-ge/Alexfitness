            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="terms-container">
                    ...
                    <div id="privacy-ka">
                        ...
                        <div class="terms-section">
                            <h2 class="section-title">11. ნაბალღოვანთა მონაცემები</h2>
                            <div class="section-content">
                                <p>ჩვენი სერვისები განკუთვნილია 18 წლის და უფროსი ასაკის პირებისთვის. ნაბალღოვანთა მონაცემების დამუშავება ხდება:</p>
                                <ul>
                                    <li>მშობლის/მზრუნველის წერილობითი თანხმობით</li>
                                    <li>მშობლის/მზრუნველის თანდასწრებით კლუბში</li>
                                    <li>განსაკუთრებული ყურადღებით უსაფრთხოების უზრუნველყოფაში</li>
                                </ul>

                                <div class="highlight-box">
                                    <p><strong>მნიშვნელოვანი:</strong> ნაბალღოვნები (14-18 წელი) კლუბში დაშვებული არიან მხოლოდ მშობელ/მზრუნველთან ერთად.</p>
                                </div>
                            </div>
                        </div>
