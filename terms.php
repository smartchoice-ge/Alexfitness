            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="terms-container">
                    ...
                    <div class="terms-header">
                        ...
                        <p class="terms-subtitle">შპს „სმარტელ.ჯი"-ს ვებ-გვერდისა და აპლიკაციის გამოყენების წესები და პირობები</p>
                    </div>

                    <div class="terms-section">
                        <div class="section-content">
                            <p>წინამდებარე წესები და პირობები წარმოადგენს შპს „სმარტელ.ჯი"-ს ვებ-გვერდისა და აპლიკაციის გამოყენების წესებსა და პირობებს (შემდგომში, „წესები და პირობები"). მათზე დათანხმებით, თქვენზე გავრცელდება აღნიშნული წესებისა და პირობების მოქმედება.</p>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>მოგესალმებით! შპს სმარტელ.ჯი (ს.კ. 405771277) კლუბის წევრად მიღების შესახებ განაცხადის ხელმოწერამდე, გთხოვთ გაეცნოთ შემდეგ წესებს:</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            ...
                            <ul>
                                <li><strong>2.1.</strong> კლუბის წევრის მიღებისას, შპს სმარტელ.ჯი-ს დაეყრდნობა წევრის ზემოთ აღნიშნულ განცხადებას და გარანტიას და არ არის ვალდებული განახორციელოს რაიმე სახის ფიზიკური ფორმის შეფასება, ფიზიკური მდგომარეობის განსაზღვრისთვის.</li>
                                <li><strong>2.2.</strong> თუ შპს სმარტელ.ჯი ჩაატარებს რაიმე სახის შეფასებას ან სხვა მსგავს ტესტირებას, ეს განხორციელებულ იქნება მხოლოდ მონაცემების შედარებისთვის, რათა კლუბის წევრმა შეძლოს თვალი მიადევნოს საკუთარ წინსვლას და არა დიაგნოსტირების მიზნებისთვის.</li>
                                <li><strong>2.3.</strong> შპს სმარტელ.ჯი-ს არ შეიძლება წაეყენოს რაიმე მოთხოვნები, საჩივარი ან ზარალის ანაზღაურების მოთხოვნა, ფიზიკური ფორმის შეფასების ან ანალოგიური ტესტირების შედეგების ან მათი ინტერპრეტაციის გამო.</li>
                                <li><strong>2.4.</strong> შპს სმარტელ.ჯი არ აგებს პასუხს რაიმე ზიანის გამო, რომელიც განპირობებულია კლუბის წევრის რაიმე სახის ავადმყოფობით ან მდგომარეობით, რომელზეც ვარჯიშებმა შესაძლოა უარყოფითად იმოქმედებს მის ჯანმრთელობაზე, უსაფრთხოებაზე ან ფიზიკურ მდგომარეობაზე, თუ ის შეასრულებს ასეთ სავარჯიშოებს ან მონაწილეობას მიიღებს მათში.</li>
                            </ul>
                            ...
                            <p><strong>2.5.</strong> შპს სმარტელ.ჯი პასუხს არ აგებს წევრის მდგომარეობაზე, რომელიც გამოწვეულია სპორტული კვების ან საკვები დანამატების გამოყენებით. წევრი კისრულობს ვალდებულებას გაიაროს კონსულტაციები ექიმთან საკვები დანამატების გამოყენებამდე.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>კლუბის წევრებზე გაიცემა დაშვებისათვის ბარათი ან დამატებით QR კოდი, რომლებიც საშუალებას მისცემს წევრებს შევიდნენ შპს სმარტელ.ჯი-ს (ს.კ. 405771277) ტერიტორიაზე და ისარგებლონ აღჭურვილობით.</p>
                            ...
                            <p>ბარათის შეცვლის ღირებულება განისაზღვრება მიმდინარე ფიქსირებული ტარიფის შესაბამისად. შპს სმარტელ.ჯი-ს (ს.კ. 405771277) კლუბის წევრად გახდომისას პირს შეიძლება გადაუღონ ფოტო, რომელიც უსაფრთხოების მიზნებისთვის და მონიტორინგისთვის გამოიყენება.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <ul>
                                ...
                                <li><strong>5.2.</strong> მისი ფასი განისაზღვრება შპს სმარტელ.ჯი-ს მიერ და შესაძლებელია შეიცვალოს ნებისმიერ დროს.</li>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            ...
                            <div class="highlight-box">
                                <strong>მნიშვნელოვანი:</strong> შპს სმარტელ.ჯი-ს (ს.კ. 405771277) თანამშრომლები და კონტრაქტორები პასუხს არ აგებენ პირადი ნივთების დაკარგვისთვის. კარადები არ წარმოადგენს მოწყობილობებს უსაფრთხოდ შენახვისთვის.
                            </div>
                            
                            <p>შესაბამისად, წევრი ვალდებულია კლუბის მომსახურებით სარგებლობისას თან იქონიოს ყველა ფასეული ნივთი. წინააღმდეგ შემთხვევაში შპს სმარტელ.ჯი (ს.კ. 405771277) პასუხს არ აგებს ასეთი ნივთების დაკარგვაზე ან/და დაზიანებაზე.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p><strong>7.1.</strong> წინამდებარე ხელშეკრულებაზე ხელმოწერით წევრი თანხმობას აცხადებს, რომ შპს სმარტელ.ჯი (ს.კ. 405771277) მისი პირადი მონაცემები, კერძოდ სახელი (სახელები), მისამართი, ტელეფონის ნომერი, ელექტრონული ფოსტის მისამართი დაამუშაოს პირდაპირი მარკეტინგის მიზნებისათვის და აღნიშნულ მონაცემებზე გაუგზავნოს და მიაწოდოს ინფორმაცია შპს სმარტელ.ჯი-ს (ს.კ. 405771277) არსებული, დაგეგმილი ან/და სამომავლო შეთავაზებების, რეკლამების, ფასდაკლებების, აქციებისა და ღონისძიებების შესახებ. ასევე საინფორმაციო შინაარსის შეტყობინების გაგზავნის მიზნით.</p>
                            
                            <p><strong>7.2.</strong> წევრისთვის ცნობილია, რომ ნებისმიერ დროს შეუძლია უარი განაცხადოს და უკან გამოითხოვოს წინამდებარე დოკუმენტით გაცხადებული თანხმობა მისი პირადი მონაცემების პირდაპირი მარკეტინგის მიზნებისთვის დამუშავებასთან დაკავშირებით და აღნიშნული უარი შეუძლია განაცხადოს წერილობითი ფორმით, შპს სმარტელ.ჯი-სთვის (ს.კ. 405771277) აღნიშნულის შესახებ იმავე კომუნიკაციის საშუალებით, რასაც შუალებითაც იღებს ინფორმაციას.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>შპს სმარტელ.ჯი-ს (ს.კ. 405771277) კლუბის წევრობა წევრს უფლებას აძლევს ივარჯიშოს შეძენილი აბონიმენტით განსაზღვრული ვადით და პირობით.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>შპს სმარტელ.ჯი-ს (ს.კ. 405771277) კლუბის წევრს მოეთხოვება:</p>
                            <ul>
                                ...
                                <li><strong>9.3.</strong> წინასწარ აცნობოს შპს სმარტელ.ჯი-ს (ს.კ. 405771277) თუ არსებობს რაიმე სახის დაავადება ან რისკი, კლუბის წევრის ჯანმრთელობისთვის.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            ...
                            <div class="highlight-box">
                                <strong>მნიშვნელოვანი:</strong> კლუბის წევრი თანახმაა არ განახორციელოს რაიმე მოქმედებები შპს სმარტელ.ჯი-ს (ს.კ. 405771277) შენობაში, ისეთი ნივთიერებების ზემოქმედების დროს, რომლებსაც შეუძლია დააქვეითოს მისი უნარი, მართოს აღჭურვილობა.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>კლუბის წევრობა შეიძლება შეწყდეს ვადამდე, წევრის ხანგრძლივი ავადმყოფობის ან ფიზიკური მდგომარეობის გამო. შპს სმარტელ.ჯი (ს.კ. 405771277) უფლებას იტოვებს შეწყვიტოს წევრის კონტრაქტი, შემდეგი პირობების შესაბამისად:</p>
                            <ul>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>შპს სმარტელ.ჯი (ს.კ. 405771277) არ აგებს პასუხს მისგან დამოუკიდებელი მიზეზების გამო ხელშეკრულების პირობების შეუსრულებლობაზე.</p>
                        </div>
                    </div>
                    ...
                    <div id="terms-en" style="display:none">
                        <div class="terms-header">
                            ...
                            <p class="terms-subtitle">Rules and conditions for using LLC “Smartel.ge” website and application</p>
                        </div>

                        <div class="terms-section">
                            <div class="section-content">
                                <p>These Terms and Conditions set the rules for using LLC “Smartel.ge” website and application (hereinafter, the “Terms and Conditions”). By agreeing to them, you accept that these Terms and Conditions apply to you.</p>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Welcome! Before signing the application for becoming a club member of LLC Smartel.ge (ID 405771277), please read the following rules.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                ...
                                <ul>
                                    <li><strong>2.1.</strong> Upon admission, LLC Smartel.ge relies on the member’s statements and warranty above and is not obliged to carry out any fitness or health assessment.</li>
                                    <li><strong>2.2.</strong> If LLC Smartel.ge conducts any assessment or similar testing, it is only for comparison of data so the member can track progress, not for diagnosis.</li>
                                    <li><strong>2.3.</strong> No claims or compensation requests can be made against LLC Smartel.ge regarding results or interpretation of fitness assessments or similar testing.</li>
                                    <li><strong>2.4.</strong> LLC Smartel.ge is not liable for any harm caused by any illness or condition of a member that may be adversely affected by exercise if the member performs such exercises or participates in them.</li>
                                </ul>
                                <div class="highlight-box">
                                ...
                                <p><strong>2.5.</strong> LLC Smartel.ge is not responsible for conditions caused by the use of sports nutrition or supplements. The member undertakes to consult a doctor before using any supplements.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Members are issued an access card or an additional QR code that allows entry to LLC Smartel.ge premises (ID 405771277) and use of equipment.</p>
                                ...
                                <p>The card replacement fee is determined by the current fixed tariff. Upon becoming a member of LLC Smartel.ge (ID 405771277), a photo may be taken for security and monitoring purposes.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <ul>
                                    ...
                                    <li><strong>5.2.</strong> The price is determined by LLC Smartel.ge and may change at any time.</li>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                ...
                                <div class="highlight-box">
                                    <strong>Important:</strong> Employees and contractors of LLC Smartel.ge (ID 405771277) are not responsible for lost personal items. Lockers are not secure storage devices.
                                </div>
                                <p>Therefore, members must keep valuables with them while using the club. Otherwise, LLC Smartel.ge (ID 405771277) is not liable for loss or damage.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p><strong>7.1.</strong> By signing this agreement, the member consents to LLC Smartel.ge (ID 405771277) processing their personal data (name, address, phone number, email) for direct marketing and sending information about existing, planned, or future offers, ads, discounts, promotions, events, and for informational messages.</p>
                                <p><strong>7.2.</strong> The member knows they can withdraw this consent at any time by notifying LLC Smartel.ge (ID 405771277) in writing using the same communication channel through which they receive information.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Membership in LLC Smartel.ge (ID 405771277) entitles the member to exercise for the period and under the conditions specified in the purchased membership.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Members of LLC Smartel. ge (ID 405771277) shall:</p>
                                <ul>
                                    <li><strong>9.1.</strong> Follow all club rules and the terms of this agreement;</li>
                                    <li><strong>9.2.</strong> Pay all agreed fees;</li>
                                    <li><strong>9.3.</strong> Inform LLC Smartel.ge (ID 405771277) in advance of any disease or risk to health.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                ...
                                <div class="highlight-box">
                                    <strong>Important:</strong> The member agrees not to perform any actions on the premises of LLC Smartel.ge (ID 405771277) under the influence of substances that may impair their ability to operate equipment.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Membership may be terminated early due to long illness or physical condition. LLC Smartel.ge (ID 405771277) reserves the right to terminate the member’s contract under the following conditions:</p>
                                <ul>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>LLC Smartel.ge (ID 405771277) is not liable for non-performance caused by reasons beyond its control.</p>
                            </div>
                        </div>
