...
<head>
    ...
    <title>Terms and Conditions - Luka Qaliashvili, ID: 0172409681</title>
            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="terms-container">
                    ...
                    <div class="terms-header">
                        ...
                        <p class="terms-subtitle">Luka Qaliashvili, ID: 0172409681-ის ვებ-გვერდისა და აპლიკაციის გამოყენების წესები და პირობები</p>
                    </div>

                    <div class="terms-section">
                        <div class="section-content">
                            <p>წინამდებარე წესები და პირობები წარმოადგენს Luka Qaliashvili, ID: 0172409681-ის ვებ-გვერდისა და აპლიკაციის გამოყენების წესებსა და პირობებს (შემდგომში, „წესები და პირობები"). მათზე დათანხმებით, თქვენზე გავრცელდება აღნიშნული წესებისა და პირობების მოქმედება.</p>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            ...
                            <ul>
                                <li><strong>მომსახურების მიმწოდებელი:</strong> ლუკა ქალიაშვილი, პ/ნ: 0172409681</li>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>მოგესალმებით! Luka Qaliashvili, ID: 0172409681-ის კლუბის წევრად მიღების შესახებ განაცხადის ხელმოწერამდე, გთხოვთ გაეცნოთ შემდეგ წესებს:</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            ...
                            <ul>
                                <li><strong>2.1.</strong> კლუბის წევრის მიღებისას, Luka Qaliashvili, ID: 0172409681 დაეყრდნობა წევრის ზემოთ აღნიშნულ განცხადებას და გარანტიას და არ არის ვალდებული განახორციელოს რაიმე სახის ფიზიკური ფორმის შეფასება, ფიზიკური მდგომარეობის განსაზღვრისთვის.</li>
                                <li><strong>2.2.</strong> თუ Luka Qaliashvili, ID: 0172409681 ჩაატარებს რაიმე სახის შეფასებას ან სხვა მსგავს ტესტირებას, ეს განხორციელებულ იქნება მხოლოდ მონაცემების შედარებისთვის, რათა კლუბის წევრმა შეძლოს თვალი მიადევნოს საკუთარ წინსვლას და არა დიაგნოსტირების მიზნებისთვის.</li>
                                <li><strong>2.3.</strong> Luka Qaliashvili, ID: 0172409681-ს არ შეიძლება წაეყენოს რაიმე მოთხოვნები, საჩივარი ან ზარალის ანაზღაურების მოთხოვნა, ფიზიკური ფორმის შეფასების ან ანალოგიური ტესტირების შედეგების ან მათი ინტერპრეტაციის გამო.</li>
                                <li><strong>2.4.</strong> Luka Qaliashvili, ID: 0172409681 არ აგებს პასუხს რაიმე ზიანის გამო, რომელიც განპირობებულია კლუბის წევრის რაიმე სახის ავადმყოფობით ან მდგომარეობით, რომელზეც ვარჯიშებმა შესაძლოა უარყოფითად იმოქმედებს მის ჯანმრთელობაზე, უსაფრთხოებაზე ან ფიზიკურ მდგომარეობაზე, თუ ის შეასრულებს ასეთ სავარჯიშოებს ან მონაწილეობას მიიღებს მათში.</li>
                            </ul>
                            ...
                            <p><strong>2.5.</strong> Luka Qaliashvili, ID: 0172409681 პასუხს არ აგებს წევრის მდგომარეობაზე, რომელიც გამოწვეულია სპორტული კვების ან საკვები დანამატების გამოყენებით. წევრი კისრულობს ვალდებულებას გაიაროს კონსულტაციები ექიმთან საკვები დანამატების გამოყენებამდე.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>კლუბის წევრებზე გაიცემა დაშვებისათვის ბარათი ან დამატებით QR კოდი, რომლებიც საშუალებას მისცემს წევრებს შევიდნენ Luka Qaliashvili, ID: 0172409681-ის ტერიტორიაზე და ისარგებლონ აღჭურვილობით.</p>
                            ...
                            <p>ბარათის შეცვლის ღირებულება განისაზღვრება მიმდინარე ფიქსირებული ტარიფის შესაბამისად. Luka Qaliashvili, ID: 0172409681-ის კლუბის წევრად გახდომისას პირს შეიძლება გადაუღონ ფოტო, რომელიც უსაფრთხოების მიზნებისთვის და მონიტორინგისთვის გამოიყენება.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            ...
                            <div class="highlight-box">
                                <strong>მნიშვნელოვანი:</strong> Luka Qaliashvili, ID: 0172409681-ის თანამშრომლები და კონტრაქტორები პასუხს არ აგებენ პირადი ნივთების დაკარგვისთვის. კარადები არ წარმოადგენს მოწყობილობებს უსაფრთხოდ შენახვისთვის.
                            </div>
                            
                            <p>შესაბამისად, წევრი ვალდებულია კლუბის მომსახურებით სარგებლობისას თან იქონიოს ყველა ფასეული ნივთი. წინააღმდეგ შემთხვევაში Luka Qaliashvili, ID: 0172409681 პასუხს არ აგებს ასეთი ნივთების დაკარგვაზე ან/და დაზიანებაზე.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p><strong>7.1.</strong> წინამდებარე ხელშეკრულებაზე ხელმოწერით წევრი თანხმობას აცხადებს, რომ Luka Qaliashvili, ID: 0172409681 მისი პირადი მონაცემები, კერძოდ სახელი (სახელები), მისამართი, ტელეფონის ნომერი, ელექტრონული ფოსტის მისამართი დაამუშაოს პირდაპირი მარკეტინგის მიზნებისათვის და აღნიშნულ მონაცემებზე გაუგზავნოს და მიაწოდოს ინფორმაცია Luka Qaliashvili, ID: 0172409681-ის არსებული, დაგეგმილი ან/და სამომავლო შეთავაზებების, რეკლამების, ფასდაკლებების, აქციებისა და ღონისძიებების შესახებ. ასევე საინფორმაციო შინაარსის შეტყობინების გაგზავნის მიზნით.</p>
                            
                            <p><strong>7.2.</strong> წევრისთვის ცნობილია, რომ ნებისმიერ დროს შეუძლია უარი განაცხადოს და უკან გამოითხოვოს წინამდებარე დოკუმენტით გაცხადებული თანხმობა მისი პირადი მონაცემების პირდაპირი მარკეტინგის მიზნებისთვის დამუშავებასთან დაკავშირებით და აღნიშნული უარი შეუძლია განაცხადოს წერილობითი ფორმით, Luka Qaliashvili, ID: 0172409681-ისთვის აღნიშნულის შესახებ იმავე კომუნიკაციის საშუალებით, რასაც შუალებითაც იღებს ინფორმაციას.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>Luka Qaliashvili, ID: 0172409681-ის კლუბის წევრობა წევრს უფლებას აძლევს ივარჯიშოს შეძენილი აბონიმენტით განსაზღვრული ვადით და პირობით.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>Luka Qaliashvili, ID: 0172409681-ის კლუბის წევრს მოეთხოვება:</p>
                            <ul>
                                ...
                                <li><strong>9.3.</strong> წინასწარ აცნობოს Luka Qaliashvili, ID: 0172409681-ს თუ არსებობს რაიმე სახის დაავადება ან რისკი, კლუბის წევრის ჯანმრთელობისთვის.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            ...
                            <div class="highlight-box">
                                <strong>მნიშვნელოვანი:</strong> კლუბის წევრი თანახმაა არ განახორციელოს რაიმე მოქმედებები Luka Qaliashvili, ID: 0172409681-ის შენობაში, ისეთი ნივთიერებების ზემოქმედების დროს, რომლებსაც შეუძლია დააქვეითოს მისი უნარი, მართოს აღჭურვილობა.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>კლუბის წევრობა შეიძლება შეწყდეს ვადამდე, წევრის ხანგრძლივი ავადმყოფობის ან ფიზიკური მდგომარეობის გამო. Luka Qaliashvili, ID: 0172409681 უფლებას იტოვებს შეწყვიტოს წევრის კონტრაქტი, შემდეგი პირობების შესაბამისად:</p>
                            <ul>
                    ...
                    <div class="terms-section">
                        ...
                        <div class="section-content">
                            <p>Luka Qaliashvili, ID: 0172409681 არ აგებს პასუხს მისგან დამოუკიდებელი მიზეზების გამო ხელშეკრულების პირობების შეუსრულებლობაზე.</p>
                        </div>
                    </div>
                    ...
                    <div id="terms-en" style="display:none">
                        <div class="terms-header">
                            ...
                            <p class="terms-subtitle">Rules and conditions for using the Luka Qaliashvili, ID: 0172409681 website and application</p>
                        </div>

                        <div class="terms-section">
                            <div class="section-content">
                                <p>These Terms and Conditions set the rules for using the Luka Qaliashvili, ID: 0172409681 website and application (hereinafter, the “Terms and Conditions”). By agreeing to them, you accept that these Terms and Conditions apply to you.</p>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                ...
                                <ul>
                                    <li><strong>Service Provider:</strong> Luka Qaliashvili, ID: 0172409681</li>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Welcome! Before signing the application for becoming a club member of Luka Qaliashvili, ID: 0172409681, please read the following rules.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                ...
                                <ul>
                                    <li><strong>2.1.</strong> Upon admission, Luka Qaliashvili, ID: 0172409681 relies on the member’s statements and warranty above and is not obliged to carry out any fitness or health assessment.</li>
                                    <li><strong>2.2.</strong> If Luka Qaliashvili, ID: 0172409681 conducts any assessment or similar testing, it is only for comparison of data so the member can track progress, not for diagnosis.</li>
                                    <li><strong>2.3.</strong> No claims or compensation requests can be made against Luka Qaliashvili, ID: 0172409681 regarding results or interpretation of fitness assessments or similar testing.</li>
                                    <li><strong>2.4.</strong> Luka Qaliashvili, ID: 0172409681 is not liable for any harm caused by any illness or condition of a member that may be adversely affected by exercise if the member performs such exercises or participates in them.</li>
                                </ul>
                                <div class="highlight-box">
                                ...
                                <p><strong>2.5.</strong> Luka Qaliashvili, ID: 0172409681 is not responsible for conditions caused by the use of sports nutrition or supplements. The member undertakes to consult a doctor before using any supplements.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Members are issued an access card or an additional QR code that allows entry to Luka Qaliashvili, ID: 0172409681 premises and use of equipment.</p>
                                ...
                                <p>The card replacement fee is determined by the current fixed tariff. Upon becoming a member of Luka Qaliashvili, ID: 0172409681, a photo may be taken for security and monitoring purposes.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                ...
                                <div class="highlight-box">
                                    <strong>Important:</strong> Employees and contractors of Luka Qaliashvili, ID: 0172409681 are not responsible for lost personal items. Lockers are not secure storage devices.
                                </div>
                                <p>Therefore, members must keep valuables with them while using the club. Otherwise, Luka Qaliashvili, ID: 0172409681 is not liable for loss or damage.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p><strong>7.1.</strong> By signing this agreement, the member consents to Luka Qaliashvili, ID: 0172409681 processing their personal data (name, address, phone number, email) for direct marketing and sending information about existing, planned, or future offers, ads, discounts, promotions, events, and for informational messages.</p>
                                <p><strong>7.2.</strong> The member knows they can withdraw this consent at any time by notifying Luka Qaliashvili, ID: 0172409681 in writing using the same communication channel through which they receive information.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Membership in Luka Qaliashvili, ID: 0172409681 entitles the member to exercise for the period and under the conditions specified in the purchased membership.</p>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Members of Luka Qaliashvili, ID: 0172409681 shall:</p>
                                <ul>
                                    <li><strong>9.1.</strong> Follow all club rules and the terms of this agreement;</li>
                                    <li><strong>9.2.</strong> Pay all agreed fees;</li>
                                    <li><strong>9.3.</strong> Inform Luka Qaliashvili, ID: 0172409681 in advance of any disease or risk to health.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                ...
                                <div class="highlight-box">
                                    <strong>Important:</strong> The member agrees not to perform any actions on the premises of Luka Qaliashvili, ID: 0172409681 under the influence of substances that may impair their ability to operate equipment.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Membership may be terminated early due to long illness or physical condition. Luka Qaliashvili, ID: 0172409681 reserves the right to terminate the member’s contract under the following conditions.</p>
                                <ul>
                        ...
                        <div class="terms-section">
                            ...
                            <div class="section-content">
                                <p>Luka Qaliashvili, ID: 0172409681 is not liable for non-performance caused by reasons beyond its control.</p>
                            </div>
                        </div>
