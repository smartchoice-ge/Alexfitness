...
if (isset($conn) && !$conn->connect_error) {
    // Today's count
    $sql_today = "SELECT COUNT(*) as count FROM promo_sms_logs WHERE DATE(record_date) = CURDATE()";
    ...
    // This week's count
    $sql_this_week = "SELECT COUNT(*) as count FROM promo_sms_logs WHERE YEARWEEK(record_date, 1) = YEARWEEK(CURDATE(), 1)";
    ...
    // This month's count
    $sql_this_month = "SELECT COUNT(*) as count FROM promo_sms_logs WHERE MONTH(record_date) = MONTH(CURDATE()) AND YEAR(record_date) = YEAR(CURDATE())";
